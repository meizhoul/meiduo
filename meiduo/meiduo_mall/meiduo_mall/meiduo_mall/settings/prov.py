...
SECRET_KEY = '5gl5v+kw*h(r%5pq-#9a6@qlq92h253m8*s8kc4=faw&v^+@t9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False #True为开发模式  False为上线模式
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',#cors插件
...
#自定义认证后端,django自带的认证后端默认用户名实现名实现登陆的,所以要实现多账号登陆要重写authenticate
